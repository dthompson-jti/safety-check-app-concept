...
export const initialChecks: SafetyCheck[] = (() => {
    ...
    return [
      ...
      { id: 'chk_completed_1', residents: [mockResidents[0]], status: 'complete', dueDate: inNMinutes(-30), walkingOrderIndex: walkingIndex++, lastChecked: inNMinutes(-32), completionStatus: 'All good' },
      { id: 'chk_completed_2', residents: [mockResidents[1]], status: 'complete', dueDate: inNMinutes(-60), walkingOrderIndex: walkingIndex++, lastChecked: inNMinutes(-61), completionStatus: 'Assisted' },
    ];
})();