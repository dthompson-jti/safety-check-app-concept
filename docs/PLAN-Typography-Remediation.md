...
- [ ] **[MODIFY]** `src/features/Shell/AppSideMenu.module.css`
    - Update `.title`: `1.5rem` -> `var(--font-size-2xl)`, Weight `600`.
    - Update `.menuItem`: Weight `600`.
- [ ] **[MODIFY]** `src/features/Schedule/CheckCard.module.css`
...
- [ ] **[SEARCH & DESTROY]** Find all `font-size: *rem` in `src/features/**/*.css` and replace with tokens.
