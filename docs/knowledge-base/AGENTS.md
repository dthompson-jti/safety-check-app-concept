...
*   **Reference:** See `docs/knowledge-base/SPEC-NFC-Scan-Animation.md`, `src/features/Shell/useRingAnimation.ts`.
...
*   **Reference:** See `docs/knowledge-base/SPEC-NFC-Interaction.md`, `src/features/Shell/useNfcScan.ts`.
